...
```
cd existing_repo
git remote add origin https://gitlab.com/GiulianoCalabrese/milp-approaches-for-the-satellite-constellation-design-problem.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/GiulianoCalabrese/milp-approaches-for-the-satellite-constellation-design-problem/-/settings/integrations)
